...
=============================================================================*/
// note as of 3/18 this is necessary due to hardware elboration issue:
/* [116] [error] bwrcq/C/ezw/chipyard/generators/sp26-atlas-acc/dependencies/sp26-fp-units/src/main/scala/sp26-fp-units/hardfloat/primitives.scala 78:22: Invalid bit range [hi=1, lo=-1] */
// also sus solution to make it be part of the hardfloat package
...
class VectorAddRecFN(expWidth: Int, sigWidth: Int) extends RawModule
{
    ...
    //------------------------------------------------------------------------
    //------------------------------------------------------------------------
    val addRawFN = Module(new AddRawFN1(expWidth, sigWidth))
